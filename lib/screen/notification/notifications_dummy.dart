...
final notificationDummies = <TtossNotification>[
  TtossNotification(
    ...
    DateTime.now().subtract(27.minutes), //빼기
  ),
  TtossNotification(
    NotificationType.stock,
    '인적분할에 대해 알려드릴게요.',
    DateTime.now().subtract(1.hours), //빼기
  ),
  ...
  TtossNotification(
    ...
    DateTime.now().subtract(8.hours),isRead: true //빼기
  ),
  TtossNotification(
    NotificationType.walk,
    '오늘 1000걸음을 넘겼어요. 포인트를 받아보세요.',
    DateTime.now().subtract(11.hours), //빼기
  ),
  TtossNotification(
    NotificationType.luck,
    '6월 5일, 행운 복권이 도착했어요.',
    DateTime.now().subtract(12.hours), //빼기
  ),
  TtossNotification(
    NotificationType.people,
    '띵동! 월요일 공동구매 보러가기',
    DateTime.now().subtract(1.days), //빼기
  ),
];
